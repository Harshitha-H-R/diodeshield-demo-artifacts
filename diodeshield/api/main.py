...
def capture_status() -> dict[str, Any]:
    ...
    return {
        ...
        "running": running,
        "interface": live_capture.resolved_interface if live_capture else None,
        "mode": "live_pcap_sniffer",
        "current_pps": cap_stats.get("current_pps", 0.0),
        "current_bps": cap_stats.get("current_bps", 0.0),
        "packets_captured": cap_stats.get("total_packets_received", 0),
        "packets_dropped": cap_stats.get("total_packets_dropped", 0),
        "last_capture_time": cap_stats.get("last_packet_time"),
        "error": cap_stats.get("error_message"),
    }
